                            ...
                            <div className="flex flex-col w-[240px] h-[200px] group-hover/pin:preserve-3d relative overflow-hidden group-hover/pin:overflow-visible">
                                <div className="relative w-full h-[140px] rounded-lg overflow-hidden mb-3 group-hover/pin:overflow-visible transition-transform duration-700 group-hover/pin:translate-z-[100px]">
                                    <img
                                        src={imageUrl}
                                        alt={displayName}
                                        className="w-full h-full object-cover transition-all duration-700 ease-out group-hover/pin:scale-110 group-hover/pin:rotate-3 group-hover/pin:shadow-2xl rounded-lg"
                                        loading="lazy"
                                        onError={(e) => {
                                ...
                                {description && (
                                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-primary-dark/95 to-primary/90 backdrop-blur-sm text-white p-4 transform translate-y-full group-hover/pin:translate-y-0 transition-all duration-500 ease-out rounded-b-lg shadow-lg border-t border-primary-light/30">
                                        <p className="text-sm leading-relaxed line-clamp-4 opacity-0 group-hover/pin:opacity-100 transition-opacity duration-300 delay-200 text-bg-main">
                                            {description}
                                        </p>
                                    </div>
                                )}
